...
export default function Header({ children }) {
  ...
  return (
    <>
      <h1 className="text-3xl font-extrabold text-gray-800 bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 text-transparent bg-clip-text shadow-md p-2 rounded-lg">
  本棚アプリ
</h1>

      <h1 className="text-2xl font-bold text-left">本棚アプリ</h1>
