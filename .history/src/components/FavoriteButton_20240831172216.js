...
const FavoriteButton = ({ bookId, title = '', author = '', publisher = '', published = '', image = '' }) => {
  // Recoilで状態を管理する
  ...
  const handleClick = async (event) => {
    ...
    try {
      ...
      if (isFavorite) {
        ...
        console.log("Adding favorite:", { userId: signInUser.uid, bookId, title, author, publisher, published, image });
