...
export default function Header({ children }) {
  ...
  return (
    <>
      <div className="header-container flex justify-between items-center p-4 bg-white border-b border-gray-300 m-2">
        <h1 className="header-title text-xl font-bold">本棚アプリ</h1>
        <ul className="flex">
          {signInUser?.uid ? (
